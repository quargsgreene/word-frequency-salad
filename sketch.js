...
function preload(){
  lyrics = loadStrings('Quarter-Life Crisis.txt');
  ...
  displayMoleArrangements.style('font-family', 'Monaco');
	...
	displayMoleArrangements.mousePressed(function circularMoleArrangements (){
		...
		if(isNaN(moleInt) || moleInt<0){
			let err = new Error('Please give Mx. Placenta a non-negative whole number quantity of moles. You do not have to undergo anal bleaching as a result of this infraction.');
